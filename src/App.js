...
import FrenchEasyColorMCQ from './pages/FrenchEasyColorMCQ';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path='/frencheasycolormcq' element={<FrenchEasyColorMCQ />}/>
        <Route path='/frencheasyanimalmcq' element={<FrenchEasyAnimalMCQ />}/>
        <Route path='/germaneasycolormcq' element={<GermanEasyColorMCQ/>} />
        <Route path='/germaneasyanimalmcq' element={<GermanEasyAnimalMCQ/>} />
      </Routes>
    </Router>
  );
}
